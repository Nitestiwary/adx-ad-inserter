			...
			<div class="display-content">
				<div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:20px; border-bottom:1px solid #e2e8f0; padding-bottom:12px;">
					...
					<div style="display:flex; gap: 20px; align-items: center;">
						...
						<label style="font-weight: 600; cursor: pointer; display: flex; align-items: center; gap: 8px;">
							<input type="hidden" name="adxbyms_slot_<?php echo esc_attr( $i ); ?>_show_label" value="false" />
							<input type="checkbox" name="adxbyms_slot_<?php echo esc_attr( $i ); ?>_show_label" value="true" <?php checked( get_option( "adxbyms_slot_{$i}_show_label" ), 'true' ); ?> />
							<?php esc_html_e( 'Advertisement Label', 'adx-ad-inserter' ); ?>
						</label>
					</div>
				</div>
